...
import com.hooloovoochimico.terminalauncher.system.ContactsRepository
import com.hooloovoochimico.terminalauncher.system.FileIndex
import com.hooloovoochimico.terminalauncher.system.FileSystemManager
import com.hooloovoochimico.terminalauncher.system.SearchHit
import com.hooloovoochimico.terminalauncher.system.SystemInfoProvider
...
class TerminalViewModel(app: Application) : AndroidViewModel(app) {
  ...
  /**
   * Apre il manuale. L'asset è scelto in base alla lingua (handbook_asset →
   * handbook.md inglese / handbook-it.md italiano), con fallback su handbook.md.
   * Caricato una sola volta per sessione.
   */
  private fun openManual() {
    if (manualLines.isEmpty()) {
      ...
      manualLines =
        runCatching { readAsset(str(R.string.handbook_asset)) }
          .recoverCatching { readAsset("handbook.md") }
