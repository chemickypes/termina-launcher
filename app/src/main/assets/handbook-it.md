...
| `/history` | Comandi recenti (TUI): tap per rieseguire, tieni premuto per modificare |
...
- **Manuale** (`/handbook`): questo manuale, con una scheda **anteprima** e una
  scheda **sorgente** (il markdown grezzo).
